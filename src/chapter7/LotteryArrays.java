...
public class LotteryArrays {
    ...
    public static int[] generateNumbers(){
        ...
        for (int i= 0; i< LENGTH; i++) {
            ...
            /*Generate random number and then search to make sure it doesn't already exist in the array ticket.
    ...
    //El método de librería binarySearch hace el trabajo de buscar si un elemento forma parte de un array. Si devuelve 0 o un nº mayor quiere decir que ha encontrado el elemento.
